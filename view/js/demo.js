...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
    ...
    initDocumentationCharts: function(){
        ...
        optionsDailySalesChart = {
            ...
            low: 0,
            high: 50, // nós recomendamos que você defina o high com maior valor + algo para uma melhor aparência
    ...
    initSmallGoogleMaps: function(){
        ...
        var myLatlng = new google.maps.LatLng(-15.788058, -47.885595);
        var mapOptions = {
            zoom: 13,
            center: myLatlng,
            scrollwheel: false, //we disable de scroll over the map, it is a really annoing when you scroll through page
	...
	showNotification: function(from, align){
    	...
    	$.notify({
        	icon: "notifications",
        	message: "Bem-vindo ao <b> Sistema de Agendamento da UDF </ b> - um belo brinde para todos os alunos."
